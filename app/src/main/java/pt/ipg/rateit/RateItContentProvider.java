...
public class RateItContentProvider extends ContentProvider {

    public static final String AUTHORITY = "pt.ipg.rateit";
    ...
    public static final int URI_FILME = 100;
    public static final int URI_FILME_ESPECIFICO = 101;
    public static final int URI_SERIE = 200;
    public static final int URI_SERIE_ESPECIFICO = 201;
    public static final int URI_CATEGORIA = 300;
    public static final int URI_CATEGORIA_ESPECIFICA = 301;
    ...
    private BdRateOpenHelper bdRateOpenHelper;

    private UriMatcher getUriMatcher() {
        UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

        uriMatcher.addURI(AUTHORITY, FILMES, URI_FILME);
        uriMatcher.addURI(AUTHORITY, FILMES + "/#", URI_FILME_ESPECIFICO);
        uriMatcher.addURI(AUTHORITY, SERIES, URI_SERIE);
        uriMatcher.addURI(AUTHORITY, SERIES + "/#", URI_SERIE_ESPECIFICO);
        uriMatcher.addURI(AUTHORITY, CATEGORIAS, URI_CATEGORIA);
    ...
    public boolean onCreate() {
        bdRateOpenHelper = new BdRateOpenHelper(getContext());
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        SQLiteDatabase bd = bdRateOpenHelper.getReadableDatabase();
        ...
        switch (getUriMatcher().match(uri)) {
            ...
            case URI_FILME_ESPECIFICO:
                return new BdTableFilmes(bd).query(projection, BdTableFilmes._ID + "=?", new String[] { id }, null, null, null);

            case URI_SERIE:
                return new BdTableSeries(bd).query(projection, selection, selectionArgs, null, null, sortOrder);

            case URI_SERIE_ESPECIFICO:
                return  new BdTableSeries(bd).query(projection, BdTableSeries._ID + "=?", new String[] { id }, null, null, null);
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        SQLiteDatabase bd = bdRateOpenHelper.getWritableDatabase();
