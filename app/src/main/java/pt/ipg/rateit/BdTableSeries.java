...
public class BdTableSeries implements BaseColumns {
    ...
    public static final String[] TODAS_COLUNAS = new String[] { NOME_TABELA + "." + _ID, CAMPO_NOME, CAMPO_NOTA, CAMPO_TEMPORADA, CAMPO_EPISODIO, CAMPO_DATA_VISUALIZACAO, CAMPO_CATEGORIA, CAMPO_NOME_CATEGORIA };
